    ...
    (loop  ;; label = @2
      ...
      (br_if 0 (;@2;)
        (i32.load8_u
          (local.get 2))))
    (local.get 3))
  (func $average_Array<int>_ (type 1) (param i32) (result i32)
    (local i32 i32 i32)
    ...
    (i32.div_s
      ...
      (call $Array<int>::length__
        (local.get 0))))
  (func $Array<int>::length__ (type 1) (param i32) (result i32)
    (i32.load offset=8
      (local.get 0)))
  (func $Array<int>::operator___int_ (type 2) (param i32 i32) (result i32)
    (i32.add
      (i32.load
        (local.get 0))
      (i32.shl
