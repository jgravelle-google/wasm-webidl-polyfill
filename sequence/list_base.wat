  ...
  (func $alloc_int_ (type 0) (param i32) (result i32)
    ...
    (i32.store offset=1024
      ...
      (i32.add
        ...
        (local.get 0)))
    (local.get 1))
  (func $average_List<int>_ (type 0) (param i32) (result i32)
    (local i32 i32)
    (block  ;; label = @1
      (block  ;; label = @2
        (br_if 0 (;@2;)
    ...
    (i32.div_s
      ...
      (i32.load offset=8
        (local.get 0))))
  (func $reversed_List<int>_ (type 1) (param i32 i32)
    (local.set 0
      ...
      (loop  ;; label = @2
        ...
        (br_if 0 (;@2;)
          (local.tee 1
            (i32.load offset=4
              (local.get 1)))))))
  (func $List<int>::List__ (type 0) (param i32) (result i32)
    (i32.store offset=8
      (local.get 0)
      (i32.const 0))
    (i64.store align=4
      ...
      (i64.const 0))
    (local.get 0))
  (func $List<int>::add_int_ (type 1) (param i32 i32)
    ...
    (i32.store offset=8
      ...
      (i32.add
        (i32.load offset=8
          (local.get 0))
        (i32.const 1))))
  (func $List<int>::Node::Node_int__List<int>::Node*_ (type 2) (param i32 i32 i32) (result i32)
    (i32.store offset=8
      (local.get 0)
      (i32.const 0))
    (i32.store offset=4
